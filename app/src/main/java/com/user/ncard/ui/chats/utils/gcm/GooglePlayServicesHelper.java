package com.user.ncard.ui.chats.utils.gcm;
...
public class GooglePlayServicesHelper {
    ...
    public boolean checkPlayServicesAvailable(Context context) {
        return getPlayServicesAvailabilityResultCode(context) == ConnectionResult.SUCCESS;
    }

    private int getPlayServicesAvailabilityResultCode(Context context) {
        GoogleApiAvailability apiAvailability = GoogleApiAvailability.getInstance();

...
import com.user.ncard.databinding.FragmentNameCardJobBinding
import com.user.ncard.vo.NameCard

class NameCardJobFragment : Fragment() {
    private lateinit var viewDataBinding: FragmentNameCardJobBinding
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        viewDataBinding = DataBindingUtil.inflate(inflater!!, R.layout.fragment_name_card_job, container, false)!!
    ...
    companion object {
        ...
        fun newInstance(nameCard: NameCard?, profileUri: Uri?) = NameCardJobFragment().apply {

...
public class BoxingUcrop implements IBoxingCrop {
    ...
    public void onStartCrop(Context context, Fragment fragment, @NonNull BoxingCropOption cropConfig,
        ...
        crop.setToolbarColor(context.getResources().getColor(R.color.colorBlack));
        crop.setActiveWidgetColor(context.getResources().getColor(R.color.colorDarkBlue));
        crop.setStatusBarColor(context.getResources().getColor(R.color.colorBlack));

...
public class AlbumTask {
    ...
    private void buildAlbumCover(ContentResolver cr, String buckId, AlbumEntity album) {
        ...
        // Cursor coverCursor = cr.query(Media.EXTERNAL_CONTENT_URI, photoColumn, selectionId, selectionArgs, Media.DATE_MODIFIED + " desc");
        Cursor coverCursor = cr.query(Media.EXTERNAL_CONTENT_URI, photoColumn, filterMediaSelectionId(selectionId),
